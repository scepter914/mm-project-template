...
LOOPS = Registry(
    "loop", parent=MMENGINE_LOOPS, locations=["mmdet3d.engine", "mmdet.engine"]
)
...
TRANSFORMS = Registry(
    ...
    locations=["mmdet3d.datasets.transforms", "mmdet.datasets.transforms"],
)
...
VISUALIZERS = Registry(
    ...
    locations=["mmdet3d.visualization", "mmdet.visualization"],
)
